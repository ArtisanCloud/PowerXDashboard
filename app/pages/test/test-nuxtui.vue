<template>
  <div class="min-h-screen bg-gray-50 p-8">
    <div class="max-w-4xl mx-auto">
      <h1 class="text-4xl font-bold text-gray-900 mb-8 text-center">Nuxt UI 组件测试页面</h1>
      
      <!-- 按钮测试 -->
      <UCard class="mb-6">
        <template #header>
          <h2 class="text-2xl font-semibold">按钮组件测试</h2>
        </template>
        ...
        <div class="space-y-4">
          ...
          <div class="flex flex-wrap gap-4">
            <UButton size="xs">超小按钮</UButton>
            <UButton size="sm">小按钮</UButton>
            <UButton size="md">中等按钮</UButton>
            <UButton size="lg">大按钮</UButton>
            <UButton size="xl">超大按钮</UButton>
          </div>
          
          <div class="flex flex-wrap gap-4">
            <UButton icon="i-heroicons-heart" />
            <UButton icon="i-heroicons-star" trailing>带图标</UButton>
            <UButton loading>加载中</UButton>
            <UButton disabled>禁用按钮</UButton>
          </div>
        </div>
      </UCard>
      ...
      <UCard class="mb-6">
        <template #header>
          <h2 class="text-2xl font-semibold">表单组件测试</h2>
        </template>
        
        <div class="space-y-4">
          <UInput placeholder="输入框测试" />
          <UTextarea placeholder="文本域测试" />
          <USelect 
            :options="[
              { label: '选项1', value: '1' },
              { label: '选项2', value: '2' },
      ...
      <UCard class="mb-6">
        <template #header>
          <h2 class="text-2xl font-semibold">反馈组件测试</h2>
        </template>
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center space-x-4">
            <UAvatar src="https://avatars.githubusercontent.com/u/739984?v=4" alt="头像" />
            <UAvatar size="sm" src="https://avatars.githubusercontent.com/u/739985?v=4" alt="小头像" />
            <UAvatar size="lg" src="https://avatars.githubusercontent.com/u/739986?v=4" alt="大头像" />
          </div>
        </div>
      </UCard>
      ...
      <UCard class="mb-6">
        <template #header>
          <h2 class="text-2xl font-semibold">图标测试</h2>
        </template>
...
<script setup>
useHead({
  title: 'Nuxt UI 组件测试页面',
  meta: [
    { name: 'description', content: '测试Nuxt UI组件是否正常工作' }
  ]
})
</script>