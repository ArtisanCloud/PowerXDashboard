        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-4">
              <UFormGroup label="文章标题" name="title">
                <UInput v-model="state.title" placeholder="请输入文章标题" />
              </UFormGroup>

              <UFormGroup label="文章内容" name="content">
                <UTextarea 
              ...
              <UFormGroup label="摘要" name="excerpt">
                <UTextarea 
            ...
            <div class="space-y-4">
              <UCard>
                ...
                <div class="space-y-4">
                  ...
                  <UFormGroup label="发布时间" name="publishAt">
                    <UInput 
                      v-model="state.publishAt" 
                      type="datetime-local"
                    />
                  </UFormGroup>
                </div>
              ...
              <UCard>
                ...
                <div class="space-y-4">
                  <UFormGroup label="SEO 标题" name="seoTitle">
                    <UInput 
                  ...
                  <UFormGroup label="SEO 描述" name="seoDescription">
                    <UTextarea 
                  ...
                  <UFormGroup label="关键词" name="keywords">
                    <UInput 
...
async function onSubmit() {
  try {
    ...
    toast.add({
      title: '成功',
      description: state.status === 'published' ? '文章已发布' : '文章已保存为草稿',
      color: 'green'
    })
