      ...
      >
        <div class="flex items-center gap-4">
          <div class="p-3 rounded-lg" :class="setting.iconBg">
            <UIcon :name="setting.icon" :class="setting.iconColor" class="w-6 h-6" />
          </div>
          <div>
      ...
      <div class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">设置网站的显示名称</p>
              </div>
              <UInput v-model="settings.siteName" placeholder="网站名称" class="w-64" />
            </div>

            <div class="flex items-center justify-between">
              <div>
                <label class="font-medium">网站描述</label>
                <p class="text-sm text-gray-600 dark:text-gray-400">网站的简短描述</p>
              </div>
              <UInput v-model="settings.siteDescription" placeholder="网站描述" class="w-64" />
            </div>

            <div class="flex items-center justify-between">
              <div>
                <label class="font-medium">默认语言</label>
                <p class="text-sm text-gray-600 dark:text-gray-400">系统默认显示语言</p>
              </div>
              <USelect 
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">限制登录失败次数</p>
              </div>
              <UInput 
        ...
        <div class="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
          <div class="flex gap-2">
            ...
            <UButton color="blue" @click="saveSettings">保存设置</UButton>
          </div>
        </div>
      </div>
    </UCard>
