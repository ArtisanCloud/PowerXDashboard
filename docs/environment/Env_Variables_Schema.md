<!--------------------------------------------------------------
PowerX Admin Environment Variable Schema
Maintainer: Frontend Platform Team
Last update: 2025-02-14
-------------------------------------------------------------->
# PowerX Admin 环境变量对照表
...
| `NUXT_APP_NAME` | `PowerX Admin` | 字符串 | 应用标题、Meta、欢迎引导 |
...
NUXT_APP_NAME=PowerX Admin (Dev)
...
NUXT_APP_NAME=PowerX Admin Staging
